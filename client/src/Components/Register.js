...
import {Grid,Radio,TextField,Typography,FormControl,FormHelperText,FormLabel,RadioGroup,FormControlLabel,Select,MenuItem,InputLabel,Input} from '@material-ui/core'
...
export default class Register extends Component{
    ...
    register=()=>{
      console.log("registered user with the following data :"+this.state.toString())
    }
    render(){
       return  <form >
